...
previously published RNA-seq data (Barutcu et al., 2016; GEO accession GSE75070). The processed differential expression results (GSE75070_MCF7_shRUNX1_shNS_RNAseq_log2_foldchange.txt.gz) were downloaded, and the same filters and cutoffs as described in 
